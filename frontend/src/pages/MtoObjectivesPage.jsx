...
// ✅ Import all objective data once
...
export default function MtoObjectivesPage() {
  ...
  const seoURL = `https://fueloil.in/mto/${subproduct}/${objective}/${city}`;
  ...
  <div className="inline-block">
    ...
    />
      ...
      <div className="mt-12 border-t pt-6">
        <h2 className="text-2xl font-bold mb-4 text-center text-[#980000]">Explore MTO by Objective</h2>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-2 text-blue-700 text-sm text-center">
              {list.map((item) => (
                <a
                  ...
                  href={`/mto/${item.subproduct.toLowerCase().replace(/\s+/g, '-')}/${objective.toLowerCase()}/${item.city.toLowerCase().replace(/\s+/g, '-')}`}
