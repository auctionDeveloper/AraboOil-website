...
// ✅ Import all Solvent objective JSON files
...
export default function SolventObjectivesPage() {
  ...
  const seoURL = `https://fueloil.in/solvent/${subproduct}/${objective}/${city}`;
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-10">
      <Helmet>
        ...
        <meta name="keywords" content={`${data.productname}, ${data.city}, Solvent ${objective}, FuelOil.in`} />
