...
const BASE = "https://raw.githubusercontent.com/auctionDeveloper/Fueloil-json-data/main/data/briquette/";

const objectiveFiles = {
  Supplier: "BriquetteSupplier.json",
  Trader: "BriquetteTrader.json",
  Manufacturer: "BriquetteManufacturer.json", // ✅ Corrected
  Importer: "BriquetteImporter.json",
  Distributor: "BriquetteDistributer.json",
};
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-2 text-blue-700 text-sm text-center">
                {list.map((item) => (
                  <a
                    ...
                    href={`/briquette/${toSlug(item.subproduct)}/${toSlug(objective)}/${toSlug(item.city)}`}
