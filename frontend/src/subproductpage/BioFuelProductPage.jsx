...
const BASE = "https://raw.githubusercontent.com/auctionDeveloper/Fueloil-json-data/main/data/biofuel/";

const objectiveFiles = {
  Supplier: "BiofuelSupplier.json",
  Trader: "BiofuelTrader.json",
  Manufacturer: "BiofuelManufacture.json",
  Importer: "BiofuelImporter.json",
  Distributor: "BiofuelDistributer.json",
};
