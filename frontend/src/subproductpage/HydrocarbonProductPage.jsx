...
const BASE = "https://raw.githubusercontent.com/auctionDeveloper/Fueloil-json-data/main/data/hydrocarbon/";

const objectiveFiles = {
  Supplier: "HydroCarbonSupplier.json",
  Trader: "HydroCarbonTrader.json",
  Manufacturer: "HydroCarbonManufacture.json",
  Importer: "HydroCarbonImporter.json",
  Distributor: "HydrocarbonDistributer.json", // Note lowercase 'c' in Distributer
};
