...
const BASE = "https://raw.githubusercontent.com/auctionDeveloper/Fueloil-json-data/main/data/solvent/";

const objectiveFiles = {
  Supplier: "SolventSupplier.json",
  Trader: "SolventTrader.json",
  Manufacturer: "SolventManufacture.json",
  Importer: "SolventImporter.json",
  Distributor: "SolventDistributer.json",
};
