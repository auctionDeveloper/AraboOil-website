...
const BASE = "https://raw.githubusercontent.com/auctionDeveloper/Fueloil-json-data/main/data/cnslresin/";

const objectiveFiles = {
  Supplier: "CnslSupplier.json",
  Trader: "CnslTrader.json",
  Manufacturer: "CnslManufacture.json",
  Importer: "CnslImporter.json",
  Distributor: "CnslDistributer.json",
};
