...
const BASE = "https://raw.githubusercontent.com/auctionDeveloper/Fueloil-json-data/main/data/lampoil/";

const objectiveFiles = {
  Supplier: "LampoilSupplier.json",
  Trader: "LampoilTrader.json",
  Manufacturer: "LampoilManufacture.json",
  Importer: "LampoilImporter.json",
  Distributor: "LampoilDistributer.json",
};
  ...
  <div className="w-[300px] sm:w-[350px] md:w-[380px]">
    ...
    />
      ...
      {/* <div className="mt-12 border-t pt-6">
        ...
        {loading ? (
          <p className="text-center text-gray-500">Loading objective links...</p>
        ) : (
